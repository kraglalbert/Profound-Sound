...
#import "PPAAcousticList.h"

@interface PPAAcousticList ()

@end

@implementation PPAAcousticList
...
- (void)viewDidLoad
{
    ...
    // Updating plist item 0 to 0. Acoustic = 0. Item 0 is used to remember which instrument was selected.
