...
#import "PPAElectricList.h"

@interface PPAElectricList ()

@end

@implementation PPAElectricList
...
- (void)viewDidLoad
{
    ...
    // Updating plist item 0 to 1. Electric = 1. Item 0 is used to remember which instrument was selected.
